...
export interface IBlindBuyNowSummaryProps {}

const BlindBuyNowSummary: React.FC<IBlindBuyNowSummaryProps> = (): JSX.Element => {
    ...
    const handleClickBack = () => {
        navigate(`/blind-buy-now/${projectId}`);
    };
        ...
        <Box>
            ...
            <Box marginTop={'70px'}>
                ...
                <Grid container spacing={8} sx={{ paddingTop: '0.5rem' }}>
                    <Grid item xs={6}>
                        <H6Typography sx={{ fontWeight: 700, textAlign: 'right' }}>Unit Price</H6Typography>
                    </Grid>
                    <Grid item xs={6}>
                ...
                <Grid container spacing={8} sx={{ paddingTop: '0.5rem' }}>
                    <Grid item xs={6}>
                        <H6Typography sx={{ fontWeight: 700, textAlign: 'right' }}>Amount</H6Typography>
                    </Grid>
                    <Grid item xs={6}>
                        <H5Typography sx={{ fontWeight: 700 }}>2</H5Typography>
                    </Grid>
                </Grid>
                <Grid container spacing={8} sx={{ paddingTop: '0.5rem' }}>
                    <Grid item xs={6}>
                        <H6Typography sx={{ fontWeight: 700, textAlign: 'right' }}>Subtotal</H6Typography>
                    </Grid>
                    <Grid item xs={6}>
                        <H5Typography sx={{ fontWeight: 700 }}>ELA 50.00</H5Typography>
                    </Grid>
                </Grid>
                <Grid container spacing={8} sx={{ paddingTop: '0.5rem' }}>
                    <Grid item xs={6}>
                ...
                <Grid container spacing={8} sx={{ paddingTop: '0.5rem' }}>
                    <Grid item xs={6}>
                        <H6Typography sx={{ fontWeight: 700, textAlign: 'right' }}>Total</H6Typography>
                    </Grid>
                    <Grid item xs={6}>
                        <H5Typography sx={{ fontWeight: 700 }}>~ ELA 50.22</H5Typography>
                    </Grid>
                </Grid>
            </Box>
...
export default BlindBuyNowSummary;
