            ...
            <Grid container alignItems="center" rowSpacing={2} marginTop={0}>
                ...
                {transactionsList.map((item) => (
                    <Grid container item>
                        ...
                        <Grid item xs={6} sm={transactionsTblColumns[1].width} order={{xs: 4, sm: 2}} textAlign={{xs: "right", sm: "center"}}>
                            <Typography fontSize={16} fontWeight={400}>
                                {item.user}
                            </Typography>
                        </Grid>
                        <Grid item xs={6} sm={transactionsTblColumns[2].width} order={{xs: 2, sm: 3}} textAlign={{xs: "right", sm: "center"}} alignContent={{xs: "right", sm: "center"}}>
