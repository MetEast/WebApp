...
import DeleteProduct from 'src/components/TransactionDialogs/DeleteProduct';
...
const ProductPageHeader: React.FC = (): JSX.Element => {
    ...
    const [showDeleteDlg, setShowDeleteDlg] = useState<boolean>(false);
    ...
    return (
        <>
            ...
            <ModalDialog open={showDeleteDlg} onClose={() => setShowDeleteDlg(false)}>
                <DeleteProduct onClose={() => setShowDeleteDlg(false)} />
            </ModalDialog>
        </>
    );
};
