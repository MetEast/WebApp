...
import { enumBadgeType, enumSingleNFTType, TypeProduct, TypeProductFetch, enumTransactionType, TypeNFTTransactionFetch, TypeFavouritesFetch, TypeNFTTransaction } from 'src/types/product-types'; 
